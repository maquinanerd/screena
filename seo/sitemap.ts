/**
 * seo/sitemap.ts — Builder do sitemap segmentado por idioma da Screena.
 *
 * INVARIANTE (regra 3 — Zero API externa no render):
 *   O sitemap e gerado EXCLUSIVAMENTE a partir do PostgreSQL/cache local da
 *   Screena. NUNCA consultamos TMDB, RapidAPI, Rotten Tomatoes ou qualquer
...
/**
 * Locales suportados pela Screena. No MVP somente `pt-BR` e publicavel; os
...
export interface SitemapEntry {
  /** URL absoluta canonica (ex.: https://screena.media/pt/filmes/{slug}/). */
  readonly loc: string;
