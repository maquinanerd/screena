...
/**
 * Painel editorial (antes em `/`).
 *
 * Mudou de endereco em 2026-09-15: a raiz do admin passou a ser a visao geral do
 * painel OPERACIONAL, que e o que o dono abre primeiro. O conteudo e o mesmo.
 *
...
export default async function AdminEditorialDashboardPage(): Promise<ReactNode> {
  ...
  return (
    <>
      <h1 className="ops-page-title">Painel editorial</h1>
