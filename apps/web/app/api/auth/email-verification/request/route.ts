/**
 * POST /api/auth/email-verification/request — Pedido de (re)envio da verificacao de e-mail. Responde SEMPRE 202 com o
 * mesmo corpo generico (anti-enumeracao).
 *
...
export async function POST(request: Request): Promise<Response> {
  return runAuthEndpoint((handlers) => handlers.requestEmailVerification, request);
}
