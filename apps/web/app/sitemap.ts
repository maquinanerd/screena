 ...
 * e a leitura do PostgreSQL na camada server-only
 ...
 * publicas (fallback operacional, explicito e logado). Nesse fallback, o meta
 * robots de cada pagina continua sendo a fonte de verdade para crawlers.
 */
