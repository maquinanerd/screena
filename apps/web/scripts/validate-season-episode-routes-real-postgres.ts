...
async function runChecks(prisma: PrismaLike, seams: Seams): Promise<void> {
  ...
  await seedEpisode(prisma, { seasonId: a1, tvShowId: idA, episodeNumber: 1, tmdbId: 97100011 });
  await seedEpisode(prisma, { seasonId: a1, tvShowId: idA, episodeNumber: 2, still: null, tmdbId: 97100012 });
