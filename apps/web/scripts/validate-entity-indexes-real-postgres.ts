...
async function runChecks(
  ...
  record(3, "Filmes: canonicalUrl /pt/filmes/", movie.canonicalUrl === "https://cinerie.com/pt/filmes/", `canonicalUrl=${movie.canonicalUrl}`);
  ...
  record(10, "Series: canonicalUrl /pt/series/", series.canonicalUrl === "https://cinerie.com/pt/series/", `canonicalUrl=${series.canonicalUrl}`);
