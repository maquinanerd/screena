...
> (port) e qual já tem **adapter** concreto. Criado no C7B0, atualizado até o C7B2.2.
>
...
| `identity-store.ts` | `IdentityStore` concreto (+ `findById`/`markEmailVerified` em C7B2.1, leitura do estado de verificacao em C7B2.2). |
